...
| ------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------- | ------------ |
| [Album Slideshow & Gestures](album-slideshow.md)        | Slideshow gesture navigation controls and background sync blueprints                                                                      | [arcsur](https://github.com/arcsur)                 | arcsur       |
...
| [Custom Prompt Avatars](avatar_prompt_responses.md)      | Adds the ability to select an avatar as a custom wake-word prompt                                                                         | [relust](https://github.com/relust)                 | Relu         |
